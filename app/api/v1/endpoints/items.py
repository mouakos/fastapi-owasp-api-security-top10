...
from app.dependencies import CurrentUserDependency, ItemServiceDependency
...
async def list_my_items(
    ...
    return await item_service.list_items(current_user.id, skip=skip, limit=limit)  # type: ignore [arg-type]
...
async def get_my_item(
    ...
    return await item_service.get_item_by_id(item_id=item_id, owner_id=current_user.id)  # type: ignore [arg-type]
